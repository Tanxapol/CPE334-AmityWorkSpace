      ...
      <main className='bg-gradient-to-r min-h-dvh from-gradient to-gd'>
        <Suspense fallback={<div>Loading...</div>}>
          <Routes>
            ...
            {/* LOGIN  User*/}
            <Route path='user' element={<Checklogin islogin='user' elements={<Navuser />} />}>
            ...
            {/* LOGIN  Staff*/}
            <Route path='staff' element={<Checklogin islogin='staff' elements={<Navstaff />} />}>
            ...
            {/* LOGIN  Admin*/}
            <Route path='admin' element={<Checklogin islogin='admin' elements={<Navadmin />} />}>
